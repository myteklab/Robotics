  ...
  this.optionsConfigurations = [
    {
      ...
      options: [
        ...
        ['Zones: Simple Delivery', 'worlds/challenges/zones-delivery-1.json?v=20260124'],
        ['Zones: Checkpoint Race', 'worlds/challenges/zones-checkpoint-race.json?v=20260124'],
        ['Zones: Penalty Course', 'worlds/challenges/zones-penalty-course.json?v=20260124'],
        ['Zones: Multi-Delivery', 'worlds/challenges/zones-multi-delivery.json?v=20260124'],
        ['Zones: Hold Position', 'worlds/challenges/zones-hold-position.json?v=20260124'],
      ]
    },
    {
  ...
  this.load = function (scene) {
    ...
    if (self.options.useDefaultRobot) {
      let DEFAULT_ROBOT = {
        ...
        'zones': ['forklift', 'https://raw.githubusercontent.com/QuirkyCort/gears-contributions/main/robots/Demo/linearActuatorForklift.json'],
      }
