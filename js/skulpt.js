var skulpt = new function() {
  ...
  this.externalLibs = {
    ...
    './ev3dev2/motor.py': 'ev3dev2/motor.py?v=led20260123',
    ...
    './ev3dev2/sensor/virtual.py': 'ev3dev2/sensor/virtual.py?v=display20260125',
    './simPython.js': 'js/simPython.js?v=peneffect20260315',
    ...
    './pybricks/ev3devices.py': 'pybricks/ev3devices.py?v=led20260123',
    ...
    myPromise.then(
      ...
      function(err) {
        ...
        if (err instanceof Sk.builtin.ExternalError) {
          // Silently ignore "aborted execution" - this is expected when stopping the sim
        } else {
