let MSGS = {
  ...
  '#blk-keyboard_key_tooltip#': {
    en: 'Detects if a keyboard key is pressed. Click on the simulation canvas to enable keyboard capture.',
    ru: 'Определяет, нажата ли клавиша. Нажмите на холст симулятора для захвата клавиатуры.',
    hu: 'Érzékeli, hogy le van-e nyomva egy billentyű. Kattintson a szimulációs vászonra a billentyűzet rögzítésének engedélyezéséhez.',
  },
  '#main-blocks#': {
    en: 'Blocks',
    tlh: 'Porgh',
